...
public class UserRepoImpl implements IUserRepo {
	...
	public int createUser(User user) {
		...
		int result = jdbcTemplate.update(query, new Object[] { user.getUserName(), user.getPwd(), user.getFirstName(),
				user.getLastName(), user.getRole(), user.getEmailId() });
		return result;
	}
	...
	public int updateUser(User user) {
		...
		int result = jdbcTemplate.update(query, new Object[] { user.getUserName(), user.getPwd(), user.getFirstName(),
				user.getLastName(), user.getEmailId(), user.getUserId() });
		return result;
	}
	...
	public User getUser(String userName, String pwd) {
		...
		try {
			User user = jdbcTemplate.queryForObject(query, new Object[] { userName, pwd, new UserRowMapper()},User.class);
			return user;
